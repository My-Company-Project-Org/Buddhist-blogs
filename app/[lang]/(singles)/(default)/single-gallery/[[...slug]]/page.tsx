    ...
    <>
      <div className={`pt-8 lg:pt-16`}>
        ...
        <header className="container rounded-xl">
          ...
          <div className="relative grid grid-cols-3 gap-2 my-10 sm:grid-cols-4">
            <div
              className="relative z-0 col-span-2 row-span-2 overflow-hidden cursor-pointer rounded-xl"
            ...
            <div
              className="absolute z-10 hidden px-4 py-2 rounded-full cursor-pointer md:flex md:items-center md:justify-center right-3 bottom-3 bg-neutral-100 text-neutral-500 hover:bg-neutral-200"
              onClick={handleOpenModalImageGallery}
            >
              <svg
              ...
              <span className="text-sm font-medium ms-2 text-neutral-800">
                Show all photos
              </span>
            </div>
          </div>
