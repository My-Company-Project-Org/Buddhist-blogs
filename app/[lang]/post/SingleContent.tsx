    ...
    <div className="relative">
      <div className="space-y-10 nc-SingleContent">
        ...
        <div
          ...
          ref={contentRef}
        >
          <SingleContentDemo body={post.body} />
        </div>
        ...
        <div className="max-w-screen-md mx-auto ">{/* <SingleAuthor /> */}</div>

        {/* COMMENT FORM */}
        {/* <div
          id="comments"
          className="max-w-screen-md pt-5 mx-auto scroll-mt-20"
        >
      ...
      >
        <div className="bg-white dark:bg-neutral-800 shadow-lg rounded-full ring-1 ring-offset-1 ring-neutral-900/5 p-1.5 flex items-center justify-center space-x-2 rtl:space-x-reverse text-xs">
          <PostCardLikeAction className="px-3 text-xs h-9" />
